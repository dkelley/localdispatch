...
import com.xmog.reporter.SlowPerformanceReporter;
import com.xmog.service.AccountService;
import com.xmog.web.CommonPageModelProvider;
import com.xmog.web.context.CurrentContext;
import com.xmog.web.exception.ExceptionMapper;
      ...
      public StackServletModule<Long, Long> createStackServletModule() {
        return new StackServletModule<Long, Long>(this) {
          ...
          protected String getControllerPackageName() {
            return "com.xmog.web.controller";
          }
          
          @Override
          protected String getWebSocketPackageName() {
            return "com.xmog.web.websocket";
          }          
